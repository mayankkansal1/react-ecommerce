                        ...
                        <table className="min-w-max w-full table-auto">
                            <thead>
                                <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                    ...
                                    <th className="py-3 px-6 text-center">Delievery Address</th>
                                ...
                                {orders.map(order => <tr className="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td className="py-3 px-6 text-center">
                                        <div className="">
                                            ...
                                            <div><span>{order.selectedAddress.email} </span></div>
                                            <div><span>{order.selectedAddress.phone} </span></div>
                                            <div><span>{order.selectedAddress.street} </span></div>
                                            <div><span>{order.selectedAddress.city}</span>
                                            </div>
                                            <div><span>{order.selectedAddress.state} </span></div>
                                    ...
                                    <td className="py-3 px-6 text-center">
                                        <div className="flex item-center justify-center">
                                            <div className="w-8 mr-6 transform hover:text-purple-500 hover:scale-110">
